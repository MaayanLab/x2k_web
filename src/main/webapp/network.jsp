...
<div id="everything">
    ...
    <div id="top_container">
        ...
        <div id="download_buttons">
            ...
            <br>
            <a id ="exportTFs" onclick="exportJson(this,'top_ranked_tfs',tf_string);"><button class="download_button">Download TFs as CSV</button></a>
            <br>
            <a id ="exportKinases" onclick="exportJson(this,'top_ranked_kinases',kinase_string);"><button class="download_button">Download Kinases as CSV</button></a>
        </div>

        <div id="legend">
            Network legend:
            <ul class="no_bullet">
                <li class="legend"> <svg height="12" width="12"> <circle cx="6" cy="6" r="6" fill=#46494C /> </svg> Protein</li>
                <li class="legend"> <svg height="12" width="12"> <circle cx="6" cy="6" r="6" fill=#086788 /> </svg> Kinase</li>
                <li class="legend"> <svg height="12" width="12"> <circle cx="6" cy="6" r="6" fill=#00CC99 /> </svg> Transcription Factor</li>
            </ul>
        </div>
        <div>
